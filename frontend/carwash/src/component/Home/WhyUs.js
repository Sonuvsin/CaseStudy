  ...
  return (
    <div className="component">
      <div className="banner">
        <div>
          <img className="banner__image" src={banner_2} alt="A1A LOGO" />
        </div>
        <div className="banner__contentRight">
          <br /> <br /> <br />
          <h1 className="banner__heading">You've Tried The Rest, Now Try the Best.</h1>
          <br></br>
          <p className="banner__para">
          A clean car says a lot about you. Daily car wash is the simplest solution to keep your car clean every day. Our professionals take care of your car while you can focus on other important things.
          </p>
        </div>
      </div>

      <hr />
      <h1 className="banner__heading">A1A Car wash</h1>
      ...
      <div className="banner">
        ...
        <div>
          <img className="banner__image" src={banner_3} alt="A1A LOGO" />
        </div>
      </div>

      <div className="banner">
        <div>
          <img className="banner__image" src={banner_4} alt="A1A LOGO" />
        </div>
        <div className="banner__contentRight">
      ...
      <div className="banner">
        ...
        <div>
          <img className="banner__image" src={banner_5} alt="A1A LOGO" />
        </div>
      </div>
    </div>
  );
